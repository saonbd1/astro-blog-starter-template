...
**Primary keyword:** build a URL shortener with Next.js**Secondary keywords:** Next.js URL redirect route; URL shortener API validation; dynamic short URL route**Article type:** Implementation tutorial and project case study**Evidence basis:** Source files, production build output, and API tests from the eslotmain.xyz project
...
The user submits a URL such as `https://example.com/hello`. The browser sends the URL to `POST /api/shorten`.
...
| --- | --- | --- |
| `npm run build` | Successful production build | Passed |
| Valid POST | HTTP 200 and a short URL | Passed |
| Invalid URL POST | HTTP 400 | Passed |
| Generated code request | HTTP 307 and correct `Location` | Passed |
| Missing code request | HTTP 404 | Implemented in the route handler |
...
[1]: https://nextjs.org/docs/app/guides/redirecting "Next.js: How to handle redirects"

[2]: https://nextjs.org/docs/app/api-reference/functions/redirect "Next.js redirect API reference"
